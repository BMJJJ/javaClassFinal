  ...
  <div class="container">
    ...
    <div class="mb-4">
      ...
      <div class="row">
        ...
        <div class="col-md-4 mb-2">
          <a href="${ctp}/park/mySchedule"><p><i class="fas fa-calendar-alt activity-icon"></i>나의 예약 수: <b>${scCnt}</b> 건</p></a>
        </div>
        <div class="col-md-4 mb-2">
          <a href="${ctp}/qna/qnaList"><p><i class="fas fa-paper-plane activity-icon"></i>나의 문의 수: <b>${qnCnt}</b> 건</p></a>
        </div>
      </div>
    </div>

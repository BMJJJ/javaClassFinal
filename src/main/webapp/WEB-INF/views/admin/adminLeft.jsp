...
<div class="sidebar">
  ...
  <div class="submenu">
    ...
    <a href="${ctp}/webSocket/webSocket"target="adminContent">1대1 문의 채팅방</a>
   	<a href="${ctp}/qna/qnaList"target="adminContent">QnA</a>
   	<a href="${ctp}/notify/notifyList" target="adminContent">공지 사항</a>
  </div>
  <div class="menu-item">
    <i class="fas fa-map"></i> 산책로 관리 <span class="badge"></span>
  </div>
  <div class="submenu">
    <a href="${ctp}/mapandweather/mapPlus" target="adminContent">추천 장소 올리기</a>
    <a href="${ctp}/park/parkInput"target="adminContent">산책로 장소 올리기</a>
    <a href="${ctp}/park/parkList"target="adminContent">산책로 장소 보기</a>
    <a href="${ctp}/park/parkUpdate"target="adminContent">산책로 장소 수정하기</a>
  </div>
  <%-- <a href="${ctp}/mapandweather/mapPlus" target="adminContent"><div class="menu-item">
    <i class="fas fa-map"></i> 산책로 관리
  </div></a> --%>
  <div class="menu-item">

...
<head>
  ...
  <script>
    ...
    function scheduleInputView() {
    	...
    	scheduleInput += '<tr><th>분류</th><td>';
    	scheduleInput += '<select name="part" class="form-control">';
    	scheduleInput += '<option value="산책로">산책로</option>';
    	scheduleInput += '<option value="탐방로(산)">탐방로(산)</option>';
    	scheduleInput += '<option value="탐방로(해안)">탐방로(해안)</option>';

...
import com.spring.javaclassS6.dao.MemberDAO;
...
public class MemberServiceImpl implements MemberService {
	...
	public void setMemberUpgrade(MemberVO vo) {
		memberDAO.setMemberUpgrade(vo);
	}

	@Override
	public int getBoardCount(String mid) {
		return memberDAO.getBoardCount(mid);
	}

	@Override
	public int getGuestCount(String nickName) {
		return memberDAO.getGuestCount(nickName);
	}

	@Override
	public int getPdsCount(String mid) {
		return memberDAO.getPdsCount(mid);
	}

	@Override
	public int getScheduleCount(String mid) {
		return memberDAO.getScheduleCount(mid);
	}

	@Override
	public int getQnaCount(String mid) {
		return memberDAO.getQnaCount(mid);
	}

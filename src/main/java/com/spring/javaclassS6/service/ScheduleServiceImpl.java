...
public class ScheduleServiceImpl implements ScheduleService {
	...
	public List<ScheduleVO> getMySchedule(String mid) {
		return scheduleDAO.getMySchedule(mid);
	}

	@Override
	public ScheduleVO getScheduleById(int idx) {
		return scheduleDAO.getScheduleById(idx);
	}

	@Override
	public int setScheduleUpdate(ScheduleVO vo) {
		return scheduleDAO.setScheduleUpdate(vo);
	}

	@Override
	public int setScheduleDelete(int idx) {
		return scheduleDAO.setScheduleDelete(idx);
	}

	@Override
	public List<String> getNationNoneCourseList(String ymd) {
		return scheduleDAO.getNationNoneCourseList(ymd);
	}

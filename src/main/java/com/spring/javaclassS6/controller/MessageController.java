...
public class MessageController {
	...
	public String getMessage(Model model,
		...
		if(msgFlag.equals("mailSendOk")) {
			...
			model.addAttribute("msg", "등록되었습니다.");
			model.addAttribute("url", "/park/mySchedule");
		}
		else if(msgFlag.equals("scheduleInputNo")) {
			model.addAttribute("msg", "등록 실패.");
			model.addAttribute("url", "/park/parkList");
		}
		else if(msgFlag.equals("scheduleUpdateOk")) {
			model.addAttribute("msg", "수정되었습니다.");
			model.addAttribute("url", "/park/mySchedule");
		}
		else if(msgFlag.equals("scheduleUpdateNo")) {
			model.addAttribute("msg", "수정 실패.");
			model.addAttribute("url", "/park/scheduleUpdate");
		}
		else if(msgFlag.equals("scheduleDeleteOk")) {
			model.addAttribute("msg", "스케줄이 삭제되었습니다.");
			model.addAttribute("url", "/park/scheduleUpdate");
		}
		else if(msgFlag.equals("scheduleDeleteNo")) {
			model.addAttribute("msg", "스케줄 삭제 실패");
			model.addAttribute("url", "/park/scheduleUpdate");
		}
		else if(msgFlag.equals("parkUpdateOk")) {
			model.addAttribute("msg", "장소가 수정되었습니다.");
			model.addAttribute("url", "/park/parkUpdate");
		}
		else if(msgFlag.equals("parkUpdateNo")) {
			model.addAttribute("msg", "장소 수정 실패");
			model.addAttribute("url", "/park/parkUpdate");
		}
		else if(msgFlag.equals("parkDeleteOk")) {
			model.addAttribute("msg", "장소가 삭제되었습니다.");
			model.addAttribute("url", "/park/parkUpdate");
		}
		else if(msgFlag.equals("parkDeleteNo")) {
			model.addAttribute("msg", "장소 삭제 실패");
			model.addAttribute("url", "/park/parkUpdate");
		}
		else if(msgFlag.equals("qnaInputOk")) {
			model.addAttribute("msg", "qna가 등록 되었습니다.");
